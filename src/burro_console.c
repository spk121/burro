...
console_render_to_cairo_surface ()
{
    ...
    timer = g_timer_elapsed (console_timer, NULL) * 1000.0;
    ...
    data = (guint32 *) cairo_image_surface_get_data (surf);
    stride = cairo_image_surface_get_stride (surf) / sizeof (guint32);
